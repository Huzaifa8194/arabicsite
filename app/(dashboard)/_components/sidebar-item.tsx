...
export const SidebarItem = ({ icon: Icon, label, href }: SidebarItemProps) => {
  ...
  const isIntroductionCourseRoute = href.includes(
    `/courses/${process.env.NEXT_PUBLIC_INTRODUTION_COURSE_ID}`
  );
  const isIntroductionCoursePage = pathname.includes(
    `/courses/${process.env.NEXT_PUBLIC_INTRODUTION_COURSE_ID}`
  );
